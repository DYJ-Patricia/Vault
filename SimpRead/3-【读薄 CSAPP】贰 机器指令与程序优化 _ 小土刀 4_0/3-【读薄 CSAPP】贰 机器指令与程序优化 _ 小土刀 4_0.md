---
url: https://www.wdxtub.com/blog/csapp/thin-csapp-2
title: 【读薄 CSAPP】贰 机器指令与程序优化 | 小土刀 4.0
author: wdxtub.com
aliases: 
 - 【读薄 CSAPP】贰 机器指令与程序优化 | 小土刀 4.0
date: 2026-04-27 22:24:20
tags:
...
*   [零 系列概览](https://www.wdxtub.com/blog/csapp/thin-csapp-0)
*   [壹 数据表示 - 不同的数据是如何存储与表示的](https://www.wdxtub.com/blog/csapp/thin-csapp-1)
*   [贰 机器指令与程序优化 - 控制流、过程调用、缓冲区溢出](https://www.wdxtub.com/blog/csapp/thin-csapp-2)
*   [叁 内存与缓存 - 内存层级与缓存机制](https://www.wdxtub.com/blog/csapp/thin-csapp-3)
*   [肆 链接 - 不同的代码如何协同](https://www.wdxtub.com/blog/csapp/thin-csapp-4)
*   [伍 异常控制流 - 不同进程间的切换与沟通](https://www.wdxtub.com/blog/csapp/thin-csapp-5)
*   [陆 系统输入输出 - 怎么把不同的内容发送到不同的地方](https://www.wdxtub.com/blog/csapp/thin-csapp-6)
*   [柒 虚拟内存与动态内存分配 - 现代计算机中内存的奥秘](https://www.wdxtub.com/blog/csapp/thin-csapp-7)
*   [捌 网络编程 - 从最原始套接字彻底理解网络编程](https://www.wdxtub.com/blog/csapp/thin-csapp-8)
*   [玖 并行与同步 - 协同工作中最重要的两个问题](https://www.wdxtub.com/blog/csapp/thin-csapp-9)

读厚部分

*   [实验概览](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-0)
*   [I Data Lab - 位操作，数据表示](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-1)
*   [II Bomb Lab - 汇编，栈帧与 gdb](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-2)
*   [III Attack Lab - 漏洞是如何被攻击的](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-3)
*   [IV Cache Lab - 实现一个缓存系统来加速计算](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-4)
*   [V Shell Lab - 实现一个 shell](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-5)
*   [VI Malloc Lab - 实现一个动态内存分配](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-6)
*   [VII Proxy Lab - 实现一个多线程带缓存的代理服务器](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-7)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14531672465886.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14531674473247.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611529201796.jpg&w=1920&q=75)
...
C 代码的意思很简单，就是把值 `t` 存储到指针 `dest` 指向的内存中。对应到汇编代码，就是把 8 字节（也就是四个字, Quad words）移动到内存中（这也就是为什叫做 `movq`）。`t` 的值保存在寄存器 %rax 中，`dest` 指向的地址保存在 %rbx 中，而 `*dest` 是取地址操作，对应于在内存中找到对应的值，也就是 `M[%rbx]`，在汇编代码中用小括号表示取地址，即 `(%rbx)`。最后转换成 3 个字节的指令，并保存在 `0x40059e` 这个地址中。
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611562175522.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611621119083.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611673348513.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611722773236.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611733132821.jpg&w=1920&q=75)
...
<table><thead><tr><th>数据类型</th><th>32 位</th><th>64 位</th><th>x86-64</th></tr></thead><tbody><tr><td>char</td><td>1</td><td>1</td><td>1</td></tr><tr><td>short</td><td>2</td><td>2</td><td>2</td></tr><tr><td>int</td><td>4</td><td>4</td><td>4</td></tr><tr><td>long</td><td>4</td><td>8</td><td>8</td></tr><tr><td>float</td><td>4</td><td>4</td><td>4</td></tr><tr><td>double</td><td>8</td><td>8</td><td>8</td></tr><tr><td>long double</td><td>-</td><td>-</td><td>10/16</td></tr><tr><td>指针</td><td>4</td><td>8</td><td>8</td></tr></tbody></table>

我们举几个具体的例子就一目了然了：

![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611748992035.jpg&w=1920&q=75)

既然是连续的地址空间，就有很多不同的访问方式，比方对于 `int val[5]` 来说

<table><thead><tr><th>引用方式</th><th>类型</th><th>值</th></tr></thead><tbody><tr><td><code>val[4]</code></td><td><code>int</code></td><td>5</td></tr><tr><td><code>val</code></td><td><code>int *</code></td><td>x</td></tr><tr><td><code>val+1</code></td><td><code>int *</code></td><td>x+4</td></tr><tr><td><code>&amp;val[2]</code></td><td><code>int *</code></td><td>x+8</td></tr><tr><td><code>val[5]</code></td><td><code>int</code></td><td>?? 越界</td></tr><tr><td><code>*(val+1)</code></td><td><code>int</code></td><td>2</td></tr><tr><td><code>val+i</code></td><td><code>int *</code></td><td>x + 4i</td></tr></tbody></table>

对于多维的数组，基本形式是 `T A[R][C]`，R 是行，C 是列，如果类型 T 占 K 个字节的话，那么数组所需要的内存是 `R*C*K` 字节。具体在内存里的排列方式如下：

![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611757048510.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611816137150.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611821730508.jpg&w=1920&q=75)

具体对齐的原则是，如果数据类型需要 K 个字节，那么地址都必须是 K 的倍数，比方说这里 int 数组 i 需要是 4 的倍数，而 v 则需要是 8 的倍数。

感谢网友『光河』的补充：文中讲 “具体对齐的原则是，如果数据类型需要 K 个字节，那么地址都必须是 K 的倍数”——这只是 windows 的原则，而 Linux 中的对齐策略是 “2 字节数据类型的地址必须为 2 的倍数，较大的数据类型（int,double,float）的地址必须是 4 的倍数”
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611824112595.jpg&w=1920&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611827570059.jpg&w=1920&q=75)

这样我们就通过不同的排列，节约了 4 个字节空间，如果这个结构体要被复制很多次，这也是很可观的内存优化。

这一节是机器代码的最后一部分，主要说说由缓冲区溢出引起的攻防大战。我们先来看看程序在内存中是如何组织的（x86-64 Linux）

![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611833392466.jpg&w=1080&q=75)
...
![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611853013958.jpg&w=1920&q=75)

结合上面代码可以看到，`call_echo` 栈帧中保存着调用之前执行指令的地址 `4006f6`，用于返回之后继续执行。我们输入字符串 `01234567890123456789012` 之后，栈帧中缓冲区被填充，如下：

![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611855170102.jpg&w=1920&q=75)

虽然缓冲区溢出了，但是并没有损害当前的状态，程序还是可以继续运行（也就是没有出现段错误），但是如果再多一点的话，也就是输入 `0123456789012345678901234`，内存中的情况是这样的：

![](https://www.wdxtub.com/_next/image?url=%2Fstatic%2Fimages%2Fcsapp%2F14611856222781.jpg&w=1920&q=75)
...
但是，除了缓冲区溢出，还有另一种攻击的方式，称为返回导向编程 [4]。可以利用修改已有的代码，来绕过系统和编译器的保护机制，攻击者控制堆栈调用以劫持程序控制流并执行针对性的机器语言指令序列（称为 Gadgets）。每一段 gadget 通常结束于 return 指令，并位于共享库代码中的子程序。系列调用这些代码，攻击者可以在拥有更简单攻击防范的程序内执行任意操作。

具体利用缓冲区进行攻击的例子，会在[【读厚 CSAPP】III Attack Lab](https://www.wdxtub.com/blog/csapp/thick-csapp-lab-3/) 中进行讲解，这里不再赘述。
...
2.  [分支预测器](https://zh.wikipedia.org/wiki/%E5%88%86%E6%94%AF%E9%A0%90%E6%B8%AC%E5%99%A8)
...
4.  [返回导向编程](https://zh.wikipedia.org/wiki/%E8%BF%94%E5%9B%9E%E5%AF%BC%E5%90%91%E7%BC%96%E7%A8%8B)